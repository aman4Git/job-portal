...
<section class="section-0 lazy d-flex bg-image-style dark align-items-center "   class="" data-bg="{{asset('assets/images/4456.jpg')}}">
    <div class="container">
        <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <p>{{ Str::words(strip_tags($latestJob->description), $words=5, '...' ) }}</p>
