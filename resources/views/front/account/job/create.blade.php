                    ...
                    <div class="card border-0 shadow mb-4 ">
                        <div class="card-body card-form p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="textarea" name="responsibilities" id="responsibilities" cols="5" rows="5" placeholder="Responsibilities"></textarea>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" placeholder="company_location" id="company_location" name="company_location" class="form-control">
                                </div>
                            </div>
