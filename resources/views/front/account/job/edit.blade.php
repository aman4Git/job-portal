                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input value="{{$job->company_location}}" type="text" placeholder="company_location" id="company_location" name="company_location" class="form-control">
                                </div>
                            </div>

                            <div class="mb-4">
                                <label for="" class="mb-2">Website</label>
                                <input type="text" value="{{$job->company_website}}"  placeholder="company_website" id="company_website" name="company_website" class="form-control">
                            </div>
                        </div>
        ...
        $.ajax({
            ...
            success : function(response){
                ...
                if(response.status == true)
                {
                    ...
                    $("#vaccancy").removeClass('is-invalid')
                    .siblings('p')
                    .removeClass('invalid-feedback')
                    .html('');
